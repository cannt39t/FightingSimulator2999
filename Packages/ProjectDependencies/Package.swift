...
let package = Package(
    ...
    targets: [
        .target(name: "ProjectDependencies",
                dependencies: [
                    .product(name: "FightingServices", package: "Services"),
                    .product(name: "PlayerServices", package: "Services"),
                    .product(name: "FightingServiceImplementation", package: "ServicesImplementation"),
                    .product(name: "PlayerServiceImplementation", package: "ServicesImplementation"),
                ],
